# Draft: Browser agents should be auditable, not undetectable

Working status: draft / not ready to publish until edited, cover image created, and frontmatter added.
...
- which account/session/site is in scope,
...
- which browser/session/site was used,
...
- what identity/session was delegated,
