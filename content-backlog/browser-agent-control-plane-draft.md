...
Source outline: `content-backlog/browser-agent-control-plane-outline.md`
...
- Generate/select 16:9 cover image.
- Store cover under `src/assets/og/`.
- Promote draft into `src/content/blog/` with frontmatter.
- Add `heroImage: ../../assets/og/<file>.png`.
- Run `npm run build`.
- Commit/push article + image together.
- Then canonical repost to DEV.to if developer-facing enough.
